...
function Dashboard({ userName }: DashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-[#F3E7D2] relative">
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 bg-black/20 z-30" onClick={() => setIsMenuOpen(false)} />
      )}

      {/* Chat Panel — back to compact bottom-right card */}
      {isChatOpen && (
        <div
          className="
            fixed bottom-6 right-6 w-96 h-[480px]
            bg-[#145147] rounded-2xl shadow-2xl z-[60] flex flex-col
          "
        >
            ...
            <div className="mb-8">
              <div className="bg-[#2a3a3a] rounded-lg p-6 mb-6">
                ...
                <div className="grid grid-cols-5 gap-4 mb-4">
                  {['Tech Innovators Inc.', 'Global Retail Group', 'Financial Services Corp.', 'Healthcare Solutions Ltd.', 'Energy Resources Plc.'].map((nm, idx) => (
                    <div key={idx} className="text-center">
                      <div className={`w-20 h-20 ${idx % 2 ? 'bg-[#145147]' : 'bg-[#F3E7D2]'} rounded-lg mb-3 mx-auto flex items-center justify-center`}>
                      ...
                      <div className={`${idx % 2 ? 'text-red-400' : 'text-green-400'} text-xs`}>{idx % 2 ? '-1.2%' : '+2.5%'}</div>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="bg-[#F3E7D2] rounded-2xl overflow-hidden shadow-xl border border-gray-200 mb-8">
              ...
              <div className="p-6 space-y-4">
                {[
                  ...
                  <div key={idx} className="flex items-center justify-between p-4 hover:bg-white/50 rounded-lg transition-colors duration-200">
                    <div className="flex items-center">
                      <div className={`w-12 h-12 ${idx % 2 ? 'bg-[#F3E7D2] border-2 border-[#145147]' : 'bg-[#145147]'} rounded-lg mr-4 flex items-center justify-center`}>
                        <div className={`w-6 h-6 ${idx % 2 ? 'text-[#145147]' : 'text-white'}`}>
                          <svg viewBox="0 0 24 24" fill="currentColor">
                            <path d="M12 2L2 7v10c0 5.55 3.84 9.74 9 11 5.16-1.26 9-5.45 9-11_V7l-10-5z" />
                          </svg>
                        </div>
                      </div>
                      <div>
          ...
          <div className="fixed inset-0 z-[75] flex items-center justify-center p-4">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
              ...
              <div className="px-6 py-4 border-t flex justify-end space-x-3">
                ...
                <button
                  onClick={submitFunds}
                  className="px-4 py-2 rounded-lg bg-[#145147] text-white hover:bg-[#0f3d37]"
                >
                  Confirm
                </button>
              </div>
