defmodule StupWeb.UserAuthTest do
  use StupWeb.ConnCase, async: true

  alias Stup.Accounts
  alias Stup.Accounts.Scope
  alias StupWeb.UserAuth

  import Stup.AccountsFixtures

  @remember_me_cookie "_stup_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, StupWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
